...
import ArrayDeclarationReportComponent from "../Component/ArrayDeclarationReport";
...
function ArrayDeclarationCalculator() {
  ...
  const handleCalculate = () => {
    ...
    axios
      .post("http://localhost:8080/calculate-array-declaration-complexity", { code })
      .then((response) => {
  ...
  return (
    <div className="container">
      ...
      <div className="report">
        <ArrayDeclarationReportComponent complexity={complexity} />
      </div>
    </div>
  );
}
